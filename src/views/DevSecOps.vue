<template>
  <div class="page-devsecops">
    ...
    <div class="section-panel section-function">
      <img class="section-panel-title" src="../assets/img/devsecops/product-function.png" alt="">
      <div class="page-content text-center">
        <img class="product-function-detail" src="../assets/img/devsecops/product-function-detail.png" alt="">
      </div>
    </div>
...
export default {
  data() {
    return {
      bannerUrl: require('../assets/img/banner/devsecops.png'),
    };
  },
};
</script>
